              ...
              <div class="thumbnail">
                ...
                <div class="ratings">
                  ...
                  <p><a href="/catalog/cart/${product.id}" class="btn btn-primary" role="button"><span
                    ...
                    <a href="/admin/catalog/product/${product.id}" class="btn btn-default" role="button">Detail</a>
                  </p>
                  <p>
                    <a href="/admin/catalog/delete/${product.id}" class="btn btn-danger" role="button">Delete</a>
                    <a href="/admin/catalog/edit/${product.id}" class="btn btn-danger" role="button">Edit</a>
                  </p>
                </div>
              </div>
            </div>
